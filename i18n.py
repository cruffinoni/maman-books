...
STRINGS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "dl.preparing": "Recherche des miroirs en cours...",
        "dl.searching_file": "Resolution des miroirs",
        "dl.auto_retry": "Source indisponible, tentative suivante...\n\u00ab {title} \u00bb",
        "dl.torrent_waiting": "Telechargement torrent lance...\n\u00ab {title} \u00bb\n\nSurveillance du dossier en cours.",
        "dl.progress_with_total": "*Telechargement*\n\u00ab {title} \u00bb\n\n{bar}  {pct}%\n{downloaded} / {total}",
        "dl.progress_no_total": "*Telechargement*\n\u00ab {title} \u00bb\n\n{downloaded} telecharges...",
        "dl.torrent_still_waiting": "Toujours en attente...\n\u00ab {title} \u00bb\n\nLe telechargement peut prendre plusieurs minutes.",
        "dl.all_mirrors_failed": "Aucune source disponible pour le moment.\nRefais une recherche ou essaie un autre titre.",
        "dl.no_result_in_size": "Tous les resultats depassent la limite de taille.\nEssaie un titre different ou verifie tes parametres.",
        "dl.converting": "Conversion vers {fmt} en cours...\n\u00ab {title} \u00bb",
    ...
    "en": {
        ...
        "dl.choose_dest": "\u00ab {title} \u00bb\n\nWhere to send it?",
        "dl.preparing": "Resolving mirrors...",
        "dl.searching_file": "Resolving mirrors",
        "dl.auto_retry": "Source unavailable, trying next...\n\u00ab {title} \u00bb",
        "dl.torrent_waiting": "Torrent download started...\n\u00ab {title} \u00bb\n\nWatching download folder.",
        "dl.progress_with_total": "*Downloading*\n\u00ab {title} \u00bb\n\n{bar}  {pct}%\n{downloaded} / {total}",
        "dl.progress_no_total": "*Downloading*\n\u00ab {title} \u00bb\n\n{downloaded} downloaded...",
        "dl.torrent_still_waiting": "Still waiting...\n\u00ab {title} \u00bb\n\nTorrent downloads can take several minutes.",
        "dl.all_mirrors_failed": "No source is available right now.\nSearch again or try a different title.",
        "dl.no_result_in_size": "All results exceed the size limit.\nTry a different title or check your settings.",
        "dl.converting": "Converting to {fmt}...\n\u00ab {title} \u00bb",
        ...
        "dl.sent_ok": "Done. Enjoy your book!",
